...
- [✅ commune-mcp](https://github.com/commune-sh/commune-mcp): Provides email infrastructure for AI agents, enabling programmatic inbox creation, bidirectional email with thread tracking, custom sending domains, structured extraction on inbound mail, attachment handling, and SMS.  (python)
